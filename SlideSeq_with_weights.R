...
# 3. Attempt to introduce weighting according to the expression level
...
# --> Tycks inte fungera något vidare, så gott som alla sägs vara
#     signifikanta. (Även mindre p-värden då fler gener?)
# 
#-----------------------------------------------------------------------
...
non_zero <- as.numeric(rowSums(testdata))
